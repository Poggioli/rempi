...
export const StyledBlockquote = styled.blockquote<{
  ...
  color: ${({ theme }) => theme.colors.grey12};
  border-left: max(${({ theme }) => theme.spaces[1]}, 0.25em) solid
    ${({ theme }) => theme.colors.primary6};
  letter-spacing: 0.05rem;
  margin: 0;
  padding: ${({ theme }) => theme.spaces[1]} 0 ${({ theme }) => theme.spaces[1]}
    min(
      ${({ theme }) => theme.spaces[5]},
      max(${({ theme }) => theme.spaces[3]}, 0.5em)
    );
