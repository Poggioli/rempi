...
export type DialogOverlayProps = Omit<
  HTMLRempiProps<typeof StyledDialogOverlay>,
  " $blur"
> &
...
>(({ ...props }, ref) => {
  return (
    <StyledDialogCloseCross {...props} ref={ref}>
      <X size={18} />
    </StyledDialogCloseCross>
  );
});
...
export const DialogTitle = forwardRef<
  typeof StyledDialogTitle,
  DialogTitleProps
>(({ ...props }, ref) => {
  return <StyledDialogTitle {...props} ref={ref} />;
});

// -x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x //

export type DialogDescriptionProps = HTMLRempiProps<
...
>(({ ...props }, ref) => {
  return <StyledDialogDescription {...props} ref={ref} />;
});
...
export const DialogFooter = forwardRef<
  typeof StyledDialogFooter,
  DialogFooterProps
>(({ ...props }, ref) => {
  return <StyledDialogFooter {...props} ref={ref} />;
});
